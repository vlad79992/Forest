...
template<typename TKey>
inline void RnB_tree_set<TKey>::right_turn(Node* node)
{
	Node* root = node->left;
...
template<typename TKey>
inline void RnB_tree_set<TKey>::left_turn(Node* node)
{
...
template<typename TKey>
inline void RnB_tree_set<TKey>::rebalance_insert(Node* node)
{
...
template<typename TKey>
inline void RnB_tree_set<TKey>::rebalance_erase(Node* node, Node* parent, bool left)
{
...
template<typename TKey>
inline void RnB_tree_set<TKey>::clear_recursive(Node* node)
{
	if (node == NIL) return;
...
template<typename TKey>
inline void RnB_tree_set<TKey>::insert(const TKey key)
{
	if (this->root == NIL)
	{
		this->root = new Node;
...
template<typename TKey>
inline bool RnB_tree_set<TKey>::contains(const TKey key)
{
...
template<typename TKey>
inline void RnB_tree_set<TKey>::erase(const TKey key)
{
...
template<typename TKey>
inline void RnB_tree_set<TKey>::clear()
{
...
template<typename TKey>
inline bool RnB_tree_set<TKey>::empty()
{
	return this->root == NIL;
}

template<typename TKey>
inline int RnB_tree_set<TKey>::size()
{
...
template<typename TKey>
inline int RnB_tree_set<TKey>::height()
{
	if (this->root == NIL) return 0;
...
template<typename TKey>
inline RnB_tree_set<TKey>::RnB_tree_set()
{
	NIL = new Node;
	NIL->color = BLACK;
...
template<typename TKey>
inline bool RnB_tree_set<TKey>::Node::insert_node(Node* new_node, Node* NIL)
{
